...
## Notes
Les images des offres d'emploi doivent s'afficher :
- Dans la liste des offres sur le site public
- Dans la page détail d'une offre
...
- Les offres sans image ont un placeholder approprié